...
- ✅ MUST: 色調 (**warm peach 肌、黒ポロシャツ、blue lanyard アクセント、コバルトブルー×白の幾何学的色面背景 — 2026-07-14 以降ブルーは差し色限定を解除し面使用可**)
...
- **color temperature: 肌は warm peach を維持しつつ、全体はクール寄り** (青×白基調、暖色ノスタルジー NG — 2026-07-14 更新)
- **background: コバルトブルー×白の幾何学的色面、窓外の青空・都市スカイライン** (旧「白・淡ベージュのシンプル背景」は 2026-07-14 で置換)
...
| 6 | 画風 | 江口寿史風シティポップ×無機質ポスター調 (細く均一な輪郭線 + フラットセル塗り + コバルトブルー×白の幾何学色面背景、2026-07-14 版)。フラット水彩 NG、ベクター NG、アニメ調 NG、青い制服 NG、温かい介護固定観念の演出 NG |
