...
### 採用FAQチャットボット (`chatbot/`、2026-07-24 デプロイ済み)
...
- 知識ベース (FAQ5件+求人サマリー) はイメージ同梱、RAGなし。`mockup/assets/data/jobs.json`/`index.html #faq` 更新時は `chatbot/src/chatbot/knowledge/` の手動同期+再デプロイが必要
