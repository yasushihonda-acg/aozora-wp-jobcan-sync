...
- **2026-07-15 リクルートページ基礎トンマナ刷新 (第2フェーズ、進行中)**: 決裁者指示で①コーポレートカラー離脱・イラスト由来配色への統一 ②tcy.co.jp/recruit・g-s.dev 的な視差効果・スクロール演出の強化 ③AI臭さの払拭による洗練度向上、を段階的に実施。Stage 1 (配色システム再定義、PR #64) / Stage 2 (ヒーローパララックス+セクション内stagger演出、PR #65) 完了・本番確認済み。Stage 3 (コンポーネントリデザイン) は決裁者が Stage 1・2 の結果を確認し具体的指摘を得てから着手するロードマップ。詳細は `docs/handoff/GOAL.md` 参照
