...
- 採用トップのセクション順: hero → philosophy → categories → numbers → flow → faq → **育休ブログ** → **お知らせ・コラム** → entry-cta (tcy.co.jp/recruit 参考)。**スタッフ紹介セクションは 2026-07-14 決裁者指示で廃止**(実写ポートレートがイラスト主体のポスタートンマナと不整合なため)
