...
## 🔄 中断点（in-flight）
- キャリアアップモデル(career-ladder)の年収帯 Lv.2〜4(実務者研修修了・現場リーダー / 介護福祉士・主任 / エリアリーダー候補・ケアマネジャー)は、給与比較スプレッドシート(市場比較202602シート)に対応データが存在せず未確定。Lv.1(301.2万円〜)・Lv.5(445.2万円〜)は実データ反映済み(PR #111、2026-08-02マージ・本番確認済み)。決裁者へ対応方針(①データ提供 ②実データ2点からの機械補間 ③現状の仮の目安値維持)の相談を送信済み、返信待ち
