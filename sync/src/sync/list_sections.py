...
# 2026-08-12: 訪問看護・夜勤専従（介護・看護）・施設長・管理者候補にも専用
# イラストが追加され、挿絵側は9系統(6→9)へさらに分離。2026-08-13: 総合職
# （営業・管理職）も専用イラスト追加により10系統(9→10)へ。CSSカラー修飾子
# は引き続き4系統のまま(4色しかCSSに定義がないため)。
# 挿絵側の変更にあわせて本マッピングを4系統から追従させる必要はない。
